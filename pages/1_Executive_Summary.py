...
<div class="card">
    ...
    <p>
    Today, these artefacts exist primarily as static documents (PDF, Word, HTML). 
    They are essential, but they are also:
    </p>
    <ul>
...
# Strategic Direction
# -------------------------
section_heading("Strategic Direction")

st.markdown("""
<div class="card">
    <h3>Aligning with the Whole-of-Government AI Plan</h3>
    <p>
    Minister Gallagher’s Whole-of-Government AI Plan makes it clear that the APS is expected to 
    modernise how information is structured and delivered. Agencies are encouraged to:
    </p>
    <ul>
        <li>shift towards structured, machine-readable artefacts</li>
        <li>reduce manual, repetitive document handling</li>
        <li>experiment safely with AI and related tools within secure environments</li>
...
# Internal Precedent
# -------------------------
section_heading("Internal Precedent")

st.markdown("""
<div class="card">
    <h3>Building on existing NDIA prototypes</h3>
    <p>
    Within NDIA, work led by colleagues such as Daniel Bridgman—using AI to interrogate complex 
    policy documents—has already demonstrated that:
    </p>
    <ul>
        <li>AI-assisted document interrogation can be safe, controlled and auditable</li>
        <li>there is clear appetite for tools that reduce manual effort and improve clarity</li>
        <li>senior leaders are prepared to endorse small, well-governed experiments when benefits are obvious</li>
    </ul>
    <p>
    The Markets Delivery Branch is well placed to extend this approach from analysis of documents 
    to modernisation of the artefacts themselves.
    </p>
</div>
""", unsafe_allow_html=True)
...
<div class="card">
    ...
    <p>
    This site is not a production system. It demonstrates how pricing artefacts could be transformed 
    into structured, digital-first resources that:
    </p>
    <ul>
        ...
        <li>inform future business cases for modernisation</li>
    </ul>
</div>
""", unsafe_allow_html=True)
