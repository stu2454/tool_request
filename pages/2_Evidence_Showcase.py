...
<div class="card">
    ...
    <p>
        These small proofs-of-concept demonstrate that NDIA artefacts do not need to remain trapped 
        in PDFs and Word documents – they can be represented in modern information formats suitable 
        for automation, search, and safe AI tooling.
    </p>
</div>
""",
    unsafe_allow_html=True
